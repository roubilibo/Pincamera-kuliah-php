    ...
    <div class="page-content-wrapper">
      <div class="row dashboard-header">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div id="row">
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 col-md-offset-3 col-sm-offset-3 col-xs-offset-3">
              <div id="row">
                <div class="col-sm-2 col-lg-6 col-md-4 img-responsive">
              ...
              <div id="row">
              <?php
                $ambil_id=$_GET['id_post'];
                $ambil_id_komen=$_GET['id_komentar'];
                $fungsi->editkomentar($ambil_id,$ambil_id_komen);
              ?>
              </div>
